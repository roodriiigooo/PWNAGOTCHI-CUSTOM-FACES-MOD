...
Activate plugins `pwnachu-exp` and `pwnachu-theme`
> **_Note 3:_** If any plugin fails to load correctly, try copying the contents of the accompanying `.yml` file into your `config.toml`.
